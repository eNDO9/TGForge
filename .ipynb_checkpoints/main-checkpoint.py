...
# --- Step 3: Fetch Channel Info UI ---
    ...
    if "participants_data" in st.session_state and not pd.DataFrame(st.session_state.participants_data).empty:
        ...
        # Define standard user info columns (adjust these if needed)
        user_cols = [
        ...
        # Group by "User ID": for standard info take the first value; for group flags, take max.
        ...
        # Optionally, create two tabs: one for all aggregated participants and one for those active in ≥ 2 chats.
